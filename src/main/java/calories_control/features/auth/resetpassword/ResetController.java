package calories_control.features.auth.resetpassword;
...
public class ResetController {
    ...
    public ResetController(ResetTokenJpa resetTokenJpa, PasswordEncoder passwordEncoder, IAuthRepository authRepository){
